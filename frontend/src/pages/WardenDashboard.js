...
function EscalateModal({ complaint, onClose, onConfirm }) {
  ...
  const reasons = [
    'Requires Hostel Manager approval',
    'Infrastructure repair needed — beyond warden scope',
    'Repeated complaint — not resolved',
    'Multiple students affected',
    'Safety hazard in hostel',
    'Other (specify below)',
  ];
  ...
  return (
    <div style={modal.overlay}>
      <div style={modal.box}>
        <h3 style={modal.title}>⚡ Escalate to Hostel Manager</h3>
        <p style={modal.sub}>
...
function WardenDashboard() {
  ...
  const handleEscalate = async (id, reason) => {
    try {
      ...
      setMessage('⚡ Complaint escalated to Hostel Manager!');
      fetchComplaints();
      setTimeout(() => setMessage(''), 3000);
    } catch (err) {
  ...
  // Warden sees hostel complaints (backend filters by routes_to = 'WARDEN')
  ...
  const tabs = [
    { id: 'all', label: '🏠 All Hostel', count: allComplaints.length },
    ...
    <div style={styles.container}>
      ...
      <div style={styles.sidebar}>
        <div style={styles.sidebarLogo}>
          ...
          <div>
            ...
            <div style={styles.sidebarLogoSub}>Warden Panel</div>
          </div>
        </div>
        ...
        <div style={styles.sidebarStats}>
          <div style={styles.sidebarStatItem}>
            <span style={styles.sidebarStatLabel}>Total Hostel</span>
            <span style={{ ...styles.sidebarStatValue, color: '#818cf8' }}>{allComplaints.length}</span>
          </div>
          <div style={styles.sidebarStatItem}>
            <span style={styles.sidebarStatLabel}>Open</span>
            <span style={{ ...styles.sidebarStatValue, color: '#f87171' }}>{openComplaints.length}</span>
          </div>
          <div style={styles.sidebarStatItem}>
        ...
        <div style={styles.sidebarUser}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={styles.sidebarUserRole}>Warden</div>
          </div>
      ...
      <div style={styles.main}>
        <div style={styles.header}>
          <div>
            <h1 style={styles.headerTitle}>Warden Dashboard</h1>
            <p style={styles.headerSub}>
              Manage all hostel-related complaints. Resolve directly or escalate to Hostel Manager.
            </p>
          </div>
        ...
        <div style={styles.statsGrid}>
          {[
            { label: 'Total Hostel', value: allComplaints.length, color: '#0891b2', bg: '#ecfeff', icon: '🏠' },
            { label: 'Open', value: openComplaints.length, color: '#e11d48', bg: '#fff1f2', icon: '🔴' },
        ...
        <div style={styles.infoBox}>
          <strong>🏠 Your Role:</strong> You manage all hostel complaints.
          You can resolve minor issues directly. For major infrastructure or repeated issues,
          escalate to the Hostel Manager.
        </div>
        ...
        <div style={styles.tableCard}>
          {loading ? (
            ...
            <div style={styles.center}>
              ...
              <div style={{ color: '#6b7280', marginTop: '8px' }}>No hostel complaints here</div>
            </div>
          ) : (
...
const styles = {
  ...
  sidebar: { width: '240px', backgroundColor: '#164e63', display: 'flex', flexDirection: 'column', padding: '24px 0', position: 'fixed', height: '100vh' },
  ...
  avatar: { width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#0891b2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: '700', fontSize: '15px', flexShrink: 0 },
  ...
  refreshBtn: { padding: '8px 16px', backgroundColor: '#0891b2', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '13px' },
  ...
  infoBox: { backgroundColor: '#ecfeff', border: '1px solid #a5f3fc', borderRadius: '8px', padding: '12px 16px', color: '#0e7490', fontSize: '13px', marginBottom: '20px' },
  ...
  tabActive: { padding: '8px 14px', borderRadius: '8px', border: '1px solid #0891b2', backgroundColor: '#0891b2', cursor: 'pointer', fontSize: '13px', color: 'white', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '6px' },
  ...
  catBadge: { backgroundColor: '#ecfeff', color: '#0891b2', padding: '3px 10px', borderRadius: '20px', fontSize: '11px', fontWeight: '600' },
...
const modal = {
  ...
  reasonItemActive: { padding: '10px 14px', borderRadius: '8px', border: '1px solid #0891b2', backgroundColor: '#ecfeff', cursor: 'pointer', fontSize: '13px', color: '#0891b2', fontWeight: '600' },
  ...
  confirmBtn: { padding: '10px 20px', backgroundColor: '#0891b2', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '14px' },
