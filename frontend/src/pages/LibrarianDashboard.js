...
// Librarian sees only library complaints and can resolve or escalate to Admin
    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        <div style={styles.sidebarLogo}>
          ...
          <div>
            ...
            <div style={styles.sidebarLogoSub}>Librarian</div>
          </div>
        </div>
        ...
        <div style={styles.sidebarUser}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={styles.sidebarUserRole}>Librarian</div>
          </div>
      ...
      <div style={styles.main}>
        <div style={styles.header}>
          <div>
            <h1 style={styles.headerTitle}>Library Complaints</h1>
            <p style={styles.headerSub}>Manage all library-related complaints from students.</p>
          </div>
        ...
        <div style={styles.statsGrid}>
          {[
            { label: 'Total', value: complaints.length, color: '#7c3aed', bg: '#faf5ff', icon: '📚' },
        ...
        <div style={styles.infoBox}>
          <strong>📚 Your Role:</strong> You handle all library complaints — book availability, reading room issues, fine disputes, etc.
          Resolve what you can, or escalate to Admin for policy-level decisions.
        </div>
            ...
            <table style={styles.table}>
              <thead>
                <tr style={styles.thead}>
                  {['ID', 'Title', 'Student', 'Status', 'Date', 'Actions'].map(h => <th key={h} style={styles.th}>{h}</th>)}
                </tr>
              </thead>
              <tbody>
                {currentList.map((c, i) => (
...
const styles = {
  ...
  sidebar: { width: '240px', backgroundColor: '#4c1d95', display: 'flex', flexDirection: 'column', padding: '24px 0', position: 'fixed', height: '100vh' },
  ...
  refreshBtn: { padding: '8px 16px', backgroundColor: '#7c3aed', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '13px' },
  ...
  infoBox: { backgroundColor: '#faf5ff', border: '1px solid #e9d5ff', borderRadius: '8px', padding: '12px 16px', color: '#6d28d9', fontSize: '13px', marginBottom: '20px' },
  ...
  tabActive: { padding: '8px 14px', borderRadius: '8px', border: '1px solid #7c3aed', backgroundColor: '#7c3aed', cursor: 'pointer', fontSize: '13px', color: 'white', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '6px' },
